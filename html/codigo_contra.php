    ...
    <div class="container-form login">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form action="php/codigo_contra.php" method="POST" class="form">
                    <label>
                        <i class='bx bxs-lock'></i>
                        <input type="number" inputmode="numeric" placeholder="Introduce el codigo de verificacón" maxlength="4" name="token" required>
                    </label>
                    <br>
