...
<body>
    ...
    <header id="main-header">
      <div id="header">
          ...
          <div class="flexiniciosesion">
              <div class="rectangulo">
                  <a class="linksindecoracion" href="login.html"><div style="color: white; font-weight: bold;" class="entraryregistrarse">ENTRAR  |  REGISTRARSE</div></a>
              </div>
          </div>
      </div>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="qsindex.html">QUIENES SOMOS</a>
                </li>
                <li class="nav-item">
      ...
      <p class="tituloqs">¿QUIÈNES SOMOS?</p>
